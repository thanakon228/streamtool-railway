...
// Reuse a generated JWT secret across restarts (so logins survive a redeploy)
// without ever committing a secret to the repo. Persists only when DATA_DIR is a
// mounted volume; returns null if it can't write, so the caller can fall back.
